        ...
        <div class="row">
          <div class="col-xl-4 col-lg-4 mb-50">
            <div class="footer-widget">
              ...
              <div class="footer-text">
                <p>
                  Full-Service Business Development and digital growth — From
                  Product Creation to Social Media.
                </p>
              </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
            <div class="contact-widget footer-widget mb-25">
              ...
              <div class="footer-text">
                <p>
                  <i class="bi bi-geo-alt-fill mr-15"></i> 32 Kyriakou Matsi, Nicosia,
                  Cyprus
                </p>
                <p>
                  <i class="bi bi-telephone-inbound-fill mr-15"></i> +375-94-48-37-18
                </p>
                <p>
                  <i class="bi bi-envelope-fill mr-15"></i> lillu.ocean@gmail.com
                </p>
              </div>
            </div>
            <div class="footer-widget">
